...
/// - Collapsible (icon-only mode, 76 px)
...
class TvSidebar extends StatelessWidget {
  ...
  /// Whether the sidebar is collapsed to icon-only mode (76 px).
    ...
    return AnimatedContainer(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          // AnimatedContainer supplies intermediate widths. Keep the icon-only
          // layout until labels have enough room so the reveal never overflows.
          final displayCollapsed = isCollapsed || constraints.maxWidth < 180;
          return Column(
            children: [
              // Logo area
              ...
              Divider(
                height: 1,
                thickness: 0.5,
                indent: displayCollapsed ? 12 : 16,
                endIndent: displayCollapsed ? 12 : 16,
                color: isDark ? AppColors.glassBorder : AppColors.lightDivider,
              ),
              Padding(
              ...
              if (onToggleCollapse != null)
                Padding(
                  ...
                  child: _SidebarNavItem(
                    icon: displayCollapsed
                        ? Icons.chevron_right_rounded
                        : Icons.chevron_left_rounded,
                    label: AppLocalizations.get(
                      displayCollapsed ? 'expand' : 'collapse',
                      locale,
                    ),
                    isSelected: false,
                    isDark: isDark,
                  ...
                  AnimatedContainer(
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: widget.isCollapsed
                          ? Center(
                              key: const ValueKey('sidebar-item-collapsed'),
                              child: Icon(
                                widget.icon,
                                size: 22,
                                color: iconColor,
                          ...
                          : Row(
                              key: const ValueKey('sidebar-item-expanded'),
                              children: [
