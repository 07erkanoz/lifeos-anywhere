...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'en': {
      ...
      'clipboardReceivedFrom': 'Clipboard received from {sender}',
      'openClipboard': 'Open',
      'clipboard': 'Clipboard',
      ...
      'freePlan': 'Free',
      'freePlanDesc': '2 devices, 1 sync job, 500 MB limit',
      ...
      'removeDeviceConfirm': 'Remove {name} from your Pro devices?',
      'remove': 'Remove',
      'refreshLicense': 'Refresh License',
      'licenseRefreshed': 'License refreshed',
      'restorePurchase': 'Restore Purchase',
      'restoreSuccess': 'Purchase restored!',
      'restoreNoResult': 'No active purchase found.',
      'storeNotReady': 'Store not available yet.',
      'upgradeSuccess': 'Successfully upgraded to Pro!',
      'cancelTransfer': 'Cancel Transfer',
      'cancelTransferConfirm': 'Are you sure you want to cancel this transfer?',
      'yes': 'Yes',
      'no': 'No',
      ...
      'proFeature_bidirectionalSync': 'Two-way sync requires Pro.',
    ...
    'tr': {
      ...
      'clipboardReceivedFrom': '{sender} cihazından pano alındı',
      'openClipboard': 'Aç',
      'clipboard': 'Pano',
      ...
      'syncFailed': 'Başarısız',
      'neverSynced': 'Henüz sync yapılmadı',
      ...
      // Quick Upload
      'servers': 'Sunucular',
      'uploadingToServer': 'Sunucuya yükleniyor…',
      ...
      'freePlan': 'Ücretsiz',
      'freePlanDesc': '2 cihaz, 1 senk işi, 500 MB limit',
      ...
      'activationFailed': 'Etkinleştirme başarısız. Lütfen tekrar deneyin.',
      ...
      'restoreNoResult': 'Aktif satın alma bulunamadı.',
    ...
    'de': {
      ...
      // Quick Upload
      'servers': 'Server',
      'uploadingToServer': 'Wird auf Server hochgeladen…',
      ...
      'freePlan': 'Kostenlos',
      'freePlanDesc': '2 Geräte, 1 Sync-Job, 500 MB Limit',
      ...
      'planDeviceCount': '{current}/{max} Geräte',
      'removeDevice': 'Gerät entfernen',
      'removeDeviceConfirm': '{name} von Ihren Pro-Geräten entfernen?',
      'remove': 'Entfernen',
      'refreshLicense': 'Lizenz aktualisieren',
      'licenseRefreshed': 'Lizenz aktualisiert',
      'restorePurchase': 'Kauf wiederherstellen',
      'restoreSuccess': 'Kauf wiederhergestellt!',
      'restoreNoResult': 'Kein aktiver Kauf gefunden.',
      ...
      'proFeature_bidirectionalSync': 'Bidirektionaler Sync erfordert Pro.',
    ...
    'fr': {
      ...
      // Quick Upload
      'servers': 'Serveurs',
      'uploadingToServer': 'Envoi vers le serveur…',
      ...
      'subscription': 'Abonnement',
      'freePlan': 'Gratuit',
      'freePlanDesc': '2 appareils, 1 tâche sync, limite 500 Mo',
      ...
      'planDeviceCount': '{current}/{max} appareils',
      'removeDevice': 'Supprimer l\'appareil',
      'removeDeviceConfirm': 'Supprimer {name} de vos appareils Pro ?',
      'remove': 'Supprimer',
      'refreshLicense': 'Actualiser la licence',
      'licenseRefreshed': 'Licence actualisée',
      'restorePurchase': 'Restaurer l\'achat',
      'restoreSuccess': 'Achat restauré !',
      'restoreNoResult': 'Aucun achat actif trouvé.',
    ...
    'es': {
      ...
      'freePlan': 'Gratis',
      'freePlanDesc': '2 dispositivos, 1 trabajo sync, l\u00edmite 500 MB',
      ...
      'removeDeviceConfirm': '\u00bfEliminar {name} de tus dispositivos Pro?',
      'remove': 'Eliminar',
      'refreshLicense': 'Actualizar licencia',
      'licenseRefreshed': 'Licencia actualizada',
      'restorePurchase': 'Restaurar compra',
      'restoreSuccess': '\u00a1Compra restaurada!',
      'restoreNoResult': 'No se encontr\u00f3 compra activa.',
    ...
    'it': {
      ...
      // Quick Upload
      'servers': 'Server',
      'uploadingToServer': 'Caricamento sul server…',
      ...
      'freePlan': 'Gratuito',
      'freePlanDesc': '2 dispositivi, 1 job sync, limite 500 MB',
      ...
      'removeDeviceConfirm': 'Rimuovere {name} dai tuoi dispositivi Pro?',
      'remove': 'Rimuovi',
      'refreshLicense': 'Aggiorna licenza',
      'licenseRefreshed': 'Licenza aggiornata',
      'restorePurchase': 'Ripristina acquisto',
      'restoreSuccess': 'Acquisto ripristinato!',
      'restoreNoResult': 'Nessun acquisto attivo trovato.',
    ...
    'ru': {
      ...
      'freePlan': 'Бесплатно',
      'freePlanDesc': '2 устройства, 1 задача синхр., лимит 500 МБ',
      ...
      'planDeviceCount': '{current}/{max} устройств',
      'removeDevice': 'Удалить устройство',
      'removeDeviceConfirm': 'Удалить {name} из ваших Pro-устройств?',
      'remove': 'Удалить',
      'refreshLicense': 'Обновить лицензию',
      'licenseRefreshed': 'Лицензия обновлена',
      'restorePurchase': 'Восстановить покупку',
      'restoreSuccess': 'Покупка восстановлена!',
      'restoreNoResult': 'Активная покупка не найдена.',
      'storeNotReady': 'Магазин ещё не доступен.',
      'upgradeSuccess': 'Успешное обновление до Pro!',
      'cancelTransfer': 'Отменить передачу',
      'cancelTransferConfirm': 'Вы уверены, что хотите отменить эту передачу?',
      'yes': 'Да',
      'no': 'Нет',
      ...
      'proFeature_bidirectionalSync': 'Двусторонняя синхр. требует Pro.',
    ...
    'zh': {
      ...
      'subscription': '订阅',
      'freePlan': '免费版',
      'freePlanDesc': '2台设备, 1个同步任务, 500 MB限制',
      'upgradeToPro': '升级到Pro',
      'iHaveACode': '我有激活码',
      'activateCode': '激活代码',
      'activateCodeDesc': '输入您购买Pro时获得的激活码，在此设备上解锁Pro。',
      'activating': '正在激活…',
      'activate': '激活',
      'proActivated': 'Pro激活成功！',
      'activationFailed': '激活失败，请重试。',
      'invalidActivationCode': '激活码格式无效。',
      'deviceLimitReached': '已达设备上限，请先移除一台设备。',
      'activationCode': '激活码',
      'activationCodeHint': '将此激活码分享给您的其他设备。',
      'activeDevices': '活跃设备: {current}/{max}',
      'planDeviceCount': '{current}/{max} 台设备',
      'removeDevice': '移除设备',
      'removeDeviceConfirm': '确定要从Pro设备中移除 {name} 吗？',
      'remove': '移除',
      'refreshLicense': '刷新许可证',
      'licenseRefreshed': '许可证已刷新',
      'restorePurchase': '恢复购买',
      'restoreSuccess': '购买已恢复！',
      'restoreNoResult': '未找到有效购买。',
      'storeNotReady': '商店尚未就绪。',
      'upgradeSuccess': '成功升级到 Pro！',
      'cancelTransfer': '取消传输',
      'cancelTransferConfirm': '您确定要取消此传输吗？',
      'yes': '是',
      'no': '否',
      'proFeature': 'Pro功能',
      'proFeature_unlimitedSync': '无限同步任务需要Pro。',
      'proFeature_serverSync': '服务器同步(SFTP/FTP/WebDAV)需要Pro。',
      'proFeature_cloudSync': '云同步(Google Drive/OneDrive)需要Pro。',
      'proFeature_relayTransfer': '互联网中继传输需要Pro。',
      'proFeature_quickSendToServer': '快速发送到服务器需要Pro。',
      'proFeature_liveWatch': '实时文件监控需要Pro。',
      'proFeature_bidirectionalSync': '双向同步需要Pro。',
      'proFeature_scheduledSync': '定时同步需要Pro。',
      'proFeature_unlimitedFileSize': '超过500 MB的文件需要Pro。',
      'shareProLan': '通过局域网分享Pro',
      'shareProLanConfirm': '与{name}分享Pro激活码？这将在其设备上激活Pro。',
      'shareProLanSuccess': '成功与{name}分享Pro！',
      'shareProLanFailed': '分享Pro失败。请确保设备在线。',
      'share': '分享',
    },
    ...
    'ja': {
      ...
      'freePlan': '無料',
      'freePlanDesc': '2デバイス、1同期ジョブ、500 MB制限',
      'upgradeToPro': 'Proにアップグレード',
      'iHaveACode': 'コードを持っています',
      'activateCode': 'コードを有効化',
      'activateCodeDesc': 'Pro購入時のアクティベーションコードを入力して、このデバイスでProを有効化します。',
      'activating': '有効化中…',
      'activate': '有効化',
      'proActivated': 'Proが正常に有効化されました！',
      'activationFailed': '有効化に失敗しました。もう一度お試しください。',
      'invalidActivationCode': '無効なアクティベーションコード形式。',
      'deviceLimitReached': 'デバイス上限に達しました。先にデバイスを削除してください。',
      'activationCode': 'アクティベーションコード',
      'activationCodeHint': 'このコードを他のデバイスと共有してください。',
      'activeDevices': 'アクティブデバイス: {current}/{max}',
      'planDeviceCount': '{current}/{max} デバイス',
      'removeDevice': 'デバイスを削除',
      'removeDeviceConfirm': '{name}をProデバイスから削除しますか？',
      'remove': '削除',
      'refreshLicense': 'ライセンスを更新',
      'licenseRefreshed': 'ライセンスが更新されました',
      'restorePurchase': '購入を復元',
      'restoreSuccess': '購入が復元されました！',
      'restoreNoResult': 'アクティブな購入が見つかりません。',
      'storeNotReady': 'ストアはまだ利用できません。',
      'upgradeSuccess': 'Proへのアップグレードに成功しました！',
      'cancelTransfer': '転送をキャンセル',
      'cancelTransferConfirm': 'この転送をキャンセルしてもよろしいですか？',
      'yes': 'はい',
      'no': 'いいえ',
      'proFeature': 'Pro機能',
      'proFeature_unlimitedSync': '無制限の同期ジョブにはProが必要です。',
      'proFeature_serverSync': 'サーバー同期(SFTP/FTP/WebDAV)にはProが必要です。',
      'proFeature_cloudSync': 'クラウド同期(Google Drive/OneDrive)にはProが必要です。',
      'proFeature_relayTransfer': 'インターネットリレー転送にはProが必要です。',
      'proFeature_quickSendToServer': 'サーバーへの高速送信にはProが必要です。',
      'proFeature_liveWatch': 'リアルタイムファイル監視にはProが必要です。',
      'proFeature_bidirectionalSync': '双方向同期にはProが必要です。',
      'proFeature_scheduledSync': 'スケジュール同期にはProが必要です。',
      'proFeature_unlimitedFileSize': '500 MB以上のファイルにはProが必要です。',
      'shareProLan': 'LANでProを共有',
      'shareProLanConfirm': '{name}とProアクティベーションコードを共有しますか？デバイスでProが有効になります。',
      'shareProLanSuccess': '{name}とProの共有に成功しました！',
      'shareProLanFailed': 'Proの共有に失敗しました。デバイスがオンラインであることを確認してください。',
      'share': '共有',
    },
    ...
    'ar': {
      ...
      'freePlan': 'مجاني',
      'freePlanDesc': 'جهازان، مهمة مزامنة واحدة، حد 500 ميغابايت',
      ...
      'invalidActivationCode': 'صيغة رمز التفعيل غير صالحة.',
      'deviceLimitReached': 'تم الوصول إلى حد الأجهزة. أزل جهازاً أولاً.',
      'activationCode': 'رمز التفعيل',
      'activationCodeHint': 'شارك هذا الرمز مع أجهزتك الأخرى.',
      'activeDevices': 'الأجهزة النشطة: {current}/{max}',
      'planDeviceCount': '{current}/{max} أجهزة',
      'removeDevice': 'إزالة الجهاز',
      'removeDeviceConfirm': 'إزالة {name} من أجهزة Pro الخاصة بك؟',
      'remove': 'إزالة',
      'refreshLicense': 'تحديث الترخيص',
      'licenseRefreshed': 'تم تحديث الترخيص',
      'restorePurchase': 'استعادة الشراء',
      'restoreSuccess': 'تمت استعادة الشراء!',
      'restoreNoResult': 'لم يتم العثور على شراء نشط.',
      'storeNotReady': 'المتجر غير متاح بعد.',
      'upgradeSuccess': 'تمت الترقية إلى Pro بنجاح!',
      'cancelTransfer': 'إلغاء النقل',
      'cancelTransferConfirm': 'هل أنت متأكد من أنك تريد إلغاء هذا النقل؟',
      'yes': 'نعم',
      'no': 'لا',
      'proFeature': 'ميزة Pro',
